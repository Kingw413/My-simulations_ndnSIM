...
main(int argc, char* argv[])
{
  ...
  topologyReader.SetFileName("/home/whd/whd_ndnSIM2.1/my-simulations/topologies/topo-tree-25-node.txt");
  topologyReader.Read();
  ...
  /****************************************************************************/
  // Tracer:
  ndn::CsTracer::InstallAll("Zipf-tree-25nodes-topo_cs-trace.txt", Seconds(0.5));
  ndn::L3RateTracer::InstallAll("Zipf-tree-25nodes-topo_rate-trace.txt", Seconds(0.5));
  ndn::AppDelayTracer::InstallAll("Zipf-tree-25nodes-topo_app-delays-trace.txt");
