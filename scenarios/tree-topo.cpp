...
main(int argc, char* argv[])
{
  ...
  ndn::CsTracer::InstallAll("tree-topo_cs-trace.txt", Seconds(0.5));
  ndn::L3RateTracer::InstallAll("tree-topo_rate-trace.txt", Seconds(0.5));
  ndn::AppDelayTracer::InstallAll("tree-topo_app-delays-trace.txt");
