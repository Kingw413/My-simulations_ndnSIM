...
main(int argc, char* argv[])
{
  ...
  ndn::CsTracer::InstallAll("Zipf-simple-topo_cs-trace.txt",  Seconds(0.5));
  ndn::L3RateTracer::InstallAll("Zipf-simple-topo_rate-race.txt", Seconds(0.5));
  ndn::AppDelayTracer::InstallAll("Zipf-simple-topo_app-delays-trace.txt");
